...
class MovimentacaoEstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create movimentacao_estoque" do
    assert_difference('MovimentacaoEstoque.count') do
      post movimentacao_estoques_url, params: { movimentacao_estoque: { data: @movimentacao_estoque.data, operacao_id: @movimentacao_estoque.operacao_id, pessoa_id: @movimentacao_estoque.pessoa_id, produto_id: @movimentacao_estoque.produto_id, quantidade: @movimentacao_estoque.quantidade } }
    end
  ...
  test "should update movimentacao_estoque" do
    patch movimentacao_estoque_url(@movimentacao_estoque), params: { movimentacao_estoque: { data: @movimentacao_estoque.data, operacao_id: @movimentacao_estoque.operacao_id, pessoa_id: @movimentacao_estoque.pessoa_id, produto_id: @movimentacao_estoque.produto_id, quantidade: @movimentacao_estoque.quantidade } }
