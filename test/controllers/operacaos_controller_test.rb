...
class OperacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operacao" do
    assert_difference('Operacao.count') do
      post operacaos_url, params: { operacao: { nome: @operacao.nome, tipo: @operacao.tipo } }
    end
  ...
  test "should update operacao" do
    patch operacao_url(@operacao), params: { operacao: { nome: @operacao.nome, tipo: @operacao.tipo } }
