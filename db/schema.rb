...
ActiveRecord::Schema.define(version: 2019_11_12_233751) do
  ...
  create_table "movimentacao_estoques", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["operacao_id"], name: "index_movimentacao_estoques_on_operacao_id"
    t.index ["pessoa_id"], name: "index_movimentacao_estoques_on_pessoa_id"
  ...
  add_foreign_key "movimentacao_estoques", "operacaos"
  add_foreign_key "movimentacao_estoques", "pessoas"
